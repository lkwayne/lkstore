...
insert into categories (id, name, slug, sort_order) values
  ('11111111-0000-4000-8000-000000000001', 'Téléphones & Tablettes', 'telephones-tablettes', 1),
  ('11111111-0000-4000-8000-000000000002', 'Informatique', 'informatique', 2),
  ('11111111-0000-4000-8000-000000000003', 'Électroménager', 'electromenager', 3),
  ('11111111-0000-4000-8000-000000000004', 'Mode', 'mode', 4),
  ('11111111-0000-4000-8000-000000000005', 'Maison', 'maison', 5),
  ('11111111-0000-4000-8000-000000000006', 'Énergie solaire', 'energie-solaire', 6);

insert into subcategories (id, category_id, name, slug, sort_order) values
  ('22222222-0000-4000-8000-000000000001', '11111111-0000-4000-8000-000000000001', 'Smartphones', 'smartphones', 1),
  ('22222222-0000-4000-8000-000000000002', '11111111-0000-4000-8000-000000000001', 'Tablettes', 'tablettes', 2),
  ('22222222-0000-4000-8000-000000000003', '11111111-0000-4000-8000-000000000002', 'Ordinateurs portables', 'ordinateurs-portables', 1),
  ('22222222-0000-4000-8000-000000000004', '11111111-0000-4000-8000-000000000002', 'Accessoires informatiques', 'accessoires-informatiques', 2),
  ('22222222-0000-4000-8000-000000000005', '11111111-0000-4000-8000-000000000003', 'Réfrigérateurs', 'refrigerateurs', 1),
  ('22222222-0000-4000-8000-000000000006', '11111111-0000-4000-8000-000000000006', 'Kits solaires', 'kits-solaires', 1);

-- -------------------------------------------------------------------------
-- MARQUES
-- -------------------------------------------------------------------------
insert into brands (id, name, slug) values
  ('33333333-0000-4000-8000-000000000001', 'Samsung', 'samsung'),
...
insert into suppliers (id, name, company_name, country, city, phone, whatsapp, currency, average_lead_time_days, status, internal_notes) values
  ('44444444-0000-4000-8000-000000000001', 'Wei Chen', 'Chen Import Export', 'Chine', 'Guangzhou', '+86 130 0000 0000', '+86 130 0000 0000', 'USD', 12, 'ACTIVE', 'Fournisseur test — accessoires téléphonie et informatique.');
...
insert into products (
  ...
  (
    ...
    '33333333-0000-4000-8000-000000000003', '11111111-0000-4000-8000-000000000002', '22222222-0000-4000-8000-000000000003',
...
insert into product_images (product_id, url, alt_text, sort_order) values
  ('55555555-0000-4000-8000-000000000001', 'https://placehold.co/800x800/FD8701/FFFFFF?text=Galaxy+A15', 'Samsung Galaxy A15', 0),
  ('55555555-0000-4000-8000-000000000002', 'https://placehold.co/800x800/FD8701/FFFFFF?text=Spark+20', 'Tecno Spark 20', 0),
  ('55555555-0000-4000-8000-000000000003', 'https://placehold.co/800x800/001C4A/FFFFFF?text=Galaxy+Tab+A9', 'Samsung Galaxy Tab A9', 0),
  ('55555555-0000-4000-8000-000000000004', 'https://placehold.co/800x800/001C4A/FFFFFF?text=HP+15', 'HP 15', 0),
  ('55555555-0000-4000-8000-000000000005', 'https://placehold.co/800x800/FB1C32/FFFFFF?text=Chargeur+33W', 'Chargeur rapide 33W', 0),
  ('55555555-0000-4000-8000-000000000006', 'https://placehold.co/800x800/001C4A/FFFFFF?text=Refrigerateur', 'Réfrigérateur Hisense 168L', 0),
  ('55555555-0000-4000-8000-000000000007', 'https://placehold.co/800x800/FD8701/FFFFFF?text=Kit+Solaire', 'Kit solaire 100W', 0),
  ('55555555-0000-4000-8000-000000000008', 'https://placehold.co/800x800/FB1C32/FFFFFF?text=Housse', 'Housse smartphone universelle', 0);
